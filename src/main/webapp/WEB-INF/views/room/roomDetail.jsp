...
html {
  /* html 전체에 걸린 overflow:auto 등을 초기화 */
  overflow: visible !important;
}
body {
  /* 가로 스크롤만 숨기고, 세로 스크롤은 뷰포트에 맡기기 */
  overflow-x: hidden !important;
  overflow-y: visible !important;
}

.sticky-tabs {
  position: relative;   /* 초기엔 문서 흐름(Flow) 그대로 */
  top: 56px;
  transition: none;
}
...
.sticky-tabs.is–fixed {
  ...
  right: 0;
  z-index: 1001;
  background: #28a745;  /* 원하는 초록색으로 변경 가능 */
  color: #fff;          /* 텍스트를 흰색으로 */
  border-bottom: 1px solid #eee;
}

.sticky-tabs.is–fixed a {
  color: #fff;
}

#mainContent {
  /* 네비(56px) + 탭바(48px) 합쳐서 여백 줌 */
